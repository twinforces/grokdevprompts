...
3. **Load the Full Role from File**  
   ...
   These notes (in this repo, next to this prompt or under `plugins/ringmaster/references/`) are the authoritative source of truth. They contain the mental models, values, postures, and handoff guidance. After reading, confirm internalization out loud (e.g., "Loaded Implementer Core Values — 3am mental model, DRY, explain WHY, no fear of refactor...").
